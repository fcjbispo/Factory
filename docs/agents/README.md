...
@qa-tester create the integration tests for the authentication module
@devops-sre configure the CI pipeline for the new service
@security-analyst do the threat model for the payment flow
```
