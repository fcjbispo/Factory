...
Cada projeto Factory é documentado com templates canônicos nas seções: ADR, API, arquitetura, banco de dados, design, domínio (context-map DDD), operações, segurança, testes, decisões de produto e contexto de sessão.
